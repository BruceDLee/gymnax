...
class POCartPole(environment.Environment[EnvState, EnvParams]):
    """JAX Compatible version of CartPole-v1 OpenAI gym environment.
    ...
    def get_obs(self, state: EnvState, params=None, key=None) -> chex.Array:
        ...
        return jnp.array([state.x + params.fixation_point*params.length*jnp.cos(state.theta)])
    ...
    def observation_space(self, params: EnvParams) -> spaces.Box:
        ...
        high = jnp.array(
            [
                (params.x_threshold + params.fixation_point*params.length*jnp.cos(params.theta_threshold_radians)) * 2,
            ]
        )
